...
4. **未做的页面给出明确提示。** 设计稿里指向后续步骤的入口（店内搜索 18、地址 15/16、
   优惠券 17、配送追踪 53、商家订单详情 62 等）会 toast 说明所属屏号，不做无声失效。
